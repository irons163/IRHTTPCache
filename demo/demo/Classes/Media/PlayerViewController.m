...
- (void)viewDidLoad
{
    ...
    switch (self.demoType)
    {
        ...
        case DemoType_AVPlayer_VR:
            [self.player replaceVideoWithURL:videoUrl videoType:IRVideoTypeVR];
            break;
        ...
        case DemoType_FFmpeg_Fisheye_Hardware:
            self.player.decoder = [IRPlayerDecoder FFmpegDecoder];
            [self.player replaceVideoWithURL:videoUrl videoType:IRVideoTypeFisheye];
            break;
        case DemoType_FFmpeg_Panorama_Hardware:
            self.player.decoder = [IRPlayerDecoder FFmpegDecoder];
            [self.player replaceVideoWithURL:videoUrl videoType:IRVideoTypePano];
            break;
        case DemoType_FFmpeg_MultiModes_Hardware_Modes_Selection:
            ...
            [self.player replaceVideoWithURL:videoUrl videoType:IRVideoTypeCustom];
